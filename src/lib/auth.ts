...
// 检查管理员权限的中间件函数
export function requireAdminAuth(handler: (request: Request, context: Record<string, unknown>) => Promise<Response>) {
...
// 检查客户端访问权限
export function validateClientAccess(clientId: string): boolean {
  // 简单的客户端验证逻辑
